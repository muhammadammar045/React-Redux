...
export default function ShoppingCart() {
  ...
  if (cartTotalQuantity < 1) {
    return <h1 className="text-7xl">YOUR CART IS EMPTY</h1>;
  }
      ...
      <div className="font-[sans-serif] bg-white">
        <div className="lg:max-w-7xl max-w-xl mx-auto">
          <h2 className="text-3xl font-extrabold text-[#333]">
            Shopping Cart : # {cartTotalQuantity}
          </h2>
                  ...
                  >
                    <div className="flex gap-6">
                      <div className="h-64 bg-gray-100 p-6 rounded">
                        <img
                          src={item.img}
                          className="w-40 h-full object-contain shrink-0"
                        />
                      </div>
                      <div>
            ...
            <div className="bg-gray-100 p-8">
              ...
              <ul className="text-[#333] mt-6 divide-y">
                <li className="flex flex-wrap gap-4 text-md py-3 font-bold">
                  Total{" "}
                  <span className="ml-auto">{cartTotalPrice.toFixed(2)}</span>
                </li>
              </ul>
              <button
                type="button"
